    ...
    <div>
      ...
      <div className="topbar">
        <div className="topbar-title">
          <span style={{ color: 'var(--text-muted)', fontWeight: 400, fontSize: 14 }}>SOC /</span>{' '}
      ...
      <div className="page-container fade-in">
        ...
        <div className="grid-3 mb-24">
          ...
          <div className="card" style={{ gridColumn: 'span 2' }}>
            <div className="card-header">
              <div className="card-title"><Zap size={15} /> Activity Trend (Last 12h)</div>
            </div>
            <div className="card-body chart-container">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={trend} margin={{ top: 5, right: 10, left: 0, bottom: 0 }}>
                  ...
                  <XAxis dataKey="hour" tick={{ fontSize: 10, fill: '#4a5568' }} />
                  ...
                  <Area type="monotone" dataKey="alerts" stroke="#ff4757" fill="url(#gradAlert)" strokeWidth={2} name="Threats" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </div>
