          ...
          <div className="card-body" style={{ height: 260 }}>
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={trend}>
                ...
                <Area type="monotone" dataKey="normal" stroke="#3b82f6" fill="url(#gN)" strokeWidth={2} name="Normal Traffic" />
                <Area type="monotone" dataKey="alerts" stroke="#ff4757" fill="url(#gA)" strokeWidth={2} name="Threats" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
